...
class MLTransform(beam.PTransform[beam.PCollection[ExampleT],
  ...
  def __init__(
    ...
    self._counter = Metrics.counter(MLTransform, f'BeamML_{self.__class__.__name__}')
...
class MLTransformMetricsUsage(beam.PTransform):
  ...
  def expand(self, pipeline):
    ...
    def _increment_counters():
      ...
      transforms = (
        self._ml_transform.transforms or self._ml_transform._process_handler.transforms)
      if transforms:
